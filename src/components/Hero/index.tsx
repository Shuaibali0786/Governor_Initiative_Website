...
const Hero = () => {
  return (
    <div className={`relative z-0 w-full overflow-hidden  bg-opacity-75 bg-[url('/bg_house.jpg')] bg-cover ${poppins} `}>
        ...
        <div className='z-50 m-auto mt-6  block w-[95%] items-center justify-between md:flex md:flex-row lg:w-[90%] xl:w-[1300px]'>
            ...
            <h1 className='whitespace-nowrap text-center text-[1.5rem] font-normal leading-[2rem] tracking-wider text-main sm:text-4xl sm:leading-[3rem] md:text-left lg:text-[2.5rem]'>Kamran Khan Tessori</h1>
            ...
            <div className='relative mt-7 flex w-full items-center md:m-auto md:justify-end'>
                <Image
                src={Cover}
                alt='giaic'
