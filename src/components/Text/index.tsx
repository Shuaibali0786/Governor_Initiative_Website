...
const Text = () => {
  return (
    <div className='xl:w-[1300px] lg:w-[90%] m-auto sm:mt-20 mt-10 border-b border-zinc-300 pb-10'>
        <h1 className='text-center xl:text-[36px] sm:text-[32px] text-xl sm:leading-[2.5rem] leading-[1.75rem] text-main font-extrabold m-auto md:w-[90%]'> Certified Cloud Applied Generative AI Engineer (GenEng) and Solopreneur Developing Billion-Dollar Valued Developers and Solopreneurs</h1>
        ...
        <div className='grid sm:grid-cols-3 grid-cols-1 gap-5 mt-10 m-3 sm:m-0'>
            ...
            <Image src={Solo2} alt='solo1' className=" shadow-2xl shadow-black rounded-lg  h-[300px] object-cover w-full"/>
            <Image src={Solo3} alt='solo1' className=" shadow-2xl shadow-black rounded-lg  h-[300px] object-cover w-full"/>
